  ...
  "objects": {
    "ne_110m_admin_0_countries": {
      ...
      "geometries": [{
        ...
        "arcs": [[[127]], [[128]], [[129]], [[130]], [[131]], [[132]], [[133]], [[134]], [[135]], [[136]], [[137, 138, 139, 140]], [[141]], [[142]], [[143]], [[144]], [[145]], [[146]], [[147]], [[148]], [[149]], [[150]], [[151]], [[152]], [[153]], [[154]], [[155]], [[156]], [[157]], [[158]], [[159]]],
        "type": "MultiPolygon",
        "properties": {
          "NAME": "Canada",
          "NAME_LONG": "Canada",
        ...
        "arcs": [[[-4, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, -117, 178, 179, 180, 181]], [[182]]],
        "type": "MultiPolygon",
        "properties": {
          "NAME": "China",
          "NAME_LONG": "China",
        ...
        "arcs": [[[-65, 274, -222, -162, 275, 276, -256, 277]], [[-111, 278, 279]], [[280]]],
        "type": "MultiPolygon",
        "properties": {
          "NAME": "France",
          "NAME_LONG": "France",
        ...
        "arcs": [[[330]], [[331, 332]], [[333]], [[334]], [[335]], [[336]], [[337]], [[338]], [[339, 340]], [[341]], [[342]], [[343, 344]], [[345]]],
        "type": "MultiPolygon",
        "properties": {
          "NAME": "Indonesia",
          "NAME_LONG": "Indonesia",
        ...
        "arcs": [[[-56, -289, 511, 512, -95, -425, -260, 513, -269, -472, 514, -502, -172, -442, -170, -387, 515]], [[-421, -500, 516]], [[517, 518]], [[519]], [[520]], [[521]], [[522]], [[523]], [[524]], [[525]], [[526]], [[527]], [[528]], [[529]]],
        "type": "MultiPolygon",
        "properties": {
          "NAME": "Russia",
        ...
        "arcs": [[[-141, 578, -432, 579]], [[-139, 580]], [[581]], [[582]], [[583]], [[584]], [[585]], [[586]], [[587]], [[588]]],
        "type": "MultiPolygon",
        "properties": {
...
function _default(fn, fps) {
  ...
  var then = new Date().getTime(); // custom fps, otherwise fallback to 60
...
var _world110m = _interopRequireDefault(require("~/assets/json/world-110m.json"));

var _requestAnimationFps = _interopRequireDefault(require("~/utils/requestAnimationFps.js"));
...
exports.default = _default;
        var $1a7eb3 = exports.default || module.exports;
      
      if (typeof $1a7eb3 === 'function') {
        $1a7eb3 = $1a7eb3.options;
      }
    
        /* template */
        Object.assign($1a7eb3, (function () {
          var render = function() {
  var _vm = this
        ...
        scopedSlots: _vm._u([
          {
            key: "default",
            fn: function(ref) {
              var geographies = ref.geographies
              return _vm._l(geographies, function(geo) {
                return _c("map-geography", {
                  key: geo.rsmKey,
                  attrs: {
                    geography: geo,
                    fill: "var(--background)",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1a7eb3', $1a7eb3);
          } else {
            api.reload('$1a7eb3', $1a7eb3);
          }
        }
...
//# sourceMappingURL=/Map.fb699cc9.js.map