...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/MapTld.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  setup(props, {
    ...
    fetch("/assets/json/tlds.json").then(r => r.json()).then(data => Object.keys(data).filter(key => data[key].geo && data[key].geo.length).filter(key => data[key].Type === "country-code").map(key => {
      return {
        domain: key,
        type: data[key].Type,
    ...
    })).then(data => TLDs.value = data.slice(0, 10)) // .then(() => [...Array(2340).keys()].forEach(i => clearInterval(i))) // hack
    .then(() => {
      const randomize = () => currentTLD.value = TLDs.value[Math.floor(TLDs.value.length * Math.random())];
    ...
    (0, _compositionApi.watch)(currentTLD, () => {
      play();
    });
    return {
      currentTLD,
...
exports.default = _default;
        var $f395bd = exports.default || module.exports;
      
      if (typeof $f395bd === 'function') {
        $f395bd = $f395bd.options;
      }
    
        /* template */
        Object.assign($f395bd, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f395bd', $f395bd);
          } else {
            api.reload('$f395bd', $f395bd);
          }
        }
...
//# sourceMappingURL=/MapTld.fa7a5960.js.map