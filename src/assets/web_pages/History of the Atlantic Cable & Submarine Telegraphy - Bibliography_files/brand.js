...
(function() {
var f = document.getElementById('searchbox_014342671943176918020:h825x0y3tky');
if (!f) {
...
for (var i = 0; i < s.length; i++) {
        if (s[i].nodeName == 'SCRIPT' &&
            s[i].attributes['src'] &&
            s[i].attributes['src'].nodeValue == unescape('\x2F\x2Fcse.google.com\x2Fcoop\x2Fcse\x2Fbrand?form=searchbox_014342671943176918020%3Ah825x0y3tky')) {
          append = true;
          break;
        }
      }
